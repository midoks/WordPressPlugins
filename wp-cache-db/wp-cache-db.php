...
class wpcachedb{
	...
	public function wpcachedb_action_links($links, $file) {
    	...
    	$settings_link = '<a href="options-general.php?page=midoks-wp-cahce-db">设置</a>';
	...
	public function wpcachedb_method(){
		...
		<select name="wpcachedb_options[method]" id="method" />
			...
			<option value="saeMc" <?php if('saeMc'==$options['method']) echo "selected='selected'"; ?>>Memcache(新浪云版)</option>
		</select><br /><?php
	}
